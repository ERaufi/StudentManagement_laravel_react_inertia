...
export default function Create({ students, classes }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('student_classes.store'));
    };
        ...
        <DashboardLayout>
            <main className="p-6 flex justify-center items-center min-h-screen bg-gray-100">
                <div className="w-full max-w-lg bg-white rounded-2xl shadow-lg p-8">
                    <h1 className="text-3xl font-semibold text-gray-800 mb-6 text-center">Create Student Class Record</h1>
